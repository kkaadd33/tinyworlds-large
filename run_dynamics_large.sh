...
echo "RUN_DIR=$NG_RUN_ROOT_DIR  (LARGE dynamics 512/2048/18, batch16x4x12acc=768)"
nvidia-smi -L
torchrun --standalone --nproc_per_node=4 scripts/train_dynamics.py \
  --config configs/dynamics_large.yaml --training_config configs/training_ddp.yaml
