...
export NG_RUN_ROOT_DIR="results/large_zelda_ctx4_research"
export WANDB_RUN_GROUP="large_zelda_ctx4_research"
...
echo "ACTION ctx4 RESEARCH recipe: partial keep_rate=0.5 + FiLM 0.05 + delta + entropy. Does the character move?"
nvidia-smi -L
