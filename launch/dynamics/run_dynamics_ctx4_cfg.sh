...
export NG_RUN_ROOT_DIR="results/large_zelda_ctx4_cfg_dyn"
export WANDB_RUN_GROUP="large_zelda_ctx4_fixaction_dyn"
echo "ctx4 dynamics (512/2048/18, lr0.0002) on the FIXED ctx4 action model (LAM-controllable +1.37) -- with FiLM 0.1 + action-dropout 0.15 (CFG training) -- amplify controllability"
nvidia-smi -L
