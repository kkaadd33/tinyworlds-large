...
export NG_RUN_ROOT_DIR="results/large_zelda_ctx8"
export WANDB_RUN_GROUP="large_zelda_ctx8"
echo "LARGE dynamics CONTEXT=8 (512/2048/18, batch8x4x4acc=128, lr0.0002), reuse tok+stable action"
nvidia-smi -L
torchrun --standalone --nproc_per_node=4 scripts/train_dynamics.py \
  --config configs/dynamics_large_ctx8.yaml --training_config configs/training_ddp_ctx8.yaml
